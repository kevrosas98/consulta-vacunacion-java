...
<html lang="es">
    ...
    <body class="d-flex flex-column h-100">
        ...
        <main class="flex-shrink-0">
            <div class="container">
                <h1 class="mt-5">Reset Password Usuario</h1><hr>
                ...
                <div class="col-12 pt-4">
                    ...
                    <form id="form">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" disabled readonly class="form-control" value="<%= usu.getNroDoc()%>">
                        </div>
                        
                        <div class="mb-3">
                            <label class="form-label">Nombres:</label>
                            <input type="text" disabled readonly class="form-control" value="<%= usu.getNom()%>">
                        </div>
                        
                        <div class="mb-3">
                            <label class="form-label">Apellidos:</label>
                            <input type="text" disabled readonly class="form-control" value="<%= usu.getApe()%>">
                        </div>
                        
                        <div class="mb-3">
                            <input type="hidden" name="txtId" value="<%= usu.getIdUsuario()%>">
                            <input type="button" name="accion" class="btn btn-success" id="submit" value="Resetear">
        ...
        <script>
            $(document).ready(function () {
                ...
                $('#submit').click(function (event) {
                    ...
                    $.ajax({
                        "url": "UsuarioController?accion=Reset",
                        type: 'POST',
                        data: $("#form").serialize()
                    }).done(function (resp) {

                        Swal.fire("Mensaje de Confirmacion", "Contraseña Reseteada", "success").then(function (result) {
                            if (result.value) {
