...
<html lang="es">
    ...
    <body class="d-flex flex-column h-100">
        ...
        <main class="flex-shrink-0">
            <div class="container">
                <h1 class="mt-5">Agregar Laboratorio</h1><hr>
                ...
                <div class="col-12 pt-4">
                    ...
                    <form id="form">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="txtNombre" autocomplete="off" class="form-control" value="">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Pais:</label>
                            <input type="text" name="txtPais" autocomplete="off" class="form-control" value="">
                        </div>

                        <div class="mb-3">
                            <input type="button"  class="btn btn-success"   name="accion" id="submit" value="Agregar">
        ...
        <script>
            $(document).ready(function () {
                ...
                $('#submit').click(function () {
                    ...
                    $.ajax({
                        url: "LabController?accion=Agregar",
                        type: 'POST',
                        data: $("#form").serialize()
                    }).done(function (resp) {

                        Swal.fire("Mensaje de Confirmacion", "Laboratorio Agregado!", "success").then(function (result) {
                            if (result.value) {
