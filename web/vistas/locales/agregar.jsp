...
<html lang="es">
    ...
    <body class="d-flex flex-column h-100">
        ...
        <main class="flex-shrink-0">
            <div class="container">
                <h1 class="mt-5">Agregar Local</h1><hr>

                <div class="col-12 pt-4">

                    <%
                        OtrosDAO odao = new OtrosDAO();
                        List<Ubigeo> list = odao.listarUbigeo();
                    ...
                    <form id="form">
                        ...
                        <div class="mb-3">
                            <input type="button" name="accion" class="btn btn-success" id="submit" value="Agregar">
                            <a type="button" href="Routes?accion=listarLocales" class="btn btn-danger"> Volver </a><br>
                        </div>
        ...
        <script>
            $(document).ready(function () {
                ...
                $('#submit').click(function () {
                    ...
                    $.ajax({
                        url: "LocalController?accion=Agregar",
                        type: 'POST',
                        data: $("#form").serialize()
                    }).done(function (resp) {

                        Swal.fire("Mensaje de Confirmacion", "Local Agregado!", "success").then(function (result) {
                            if (result.value) {
