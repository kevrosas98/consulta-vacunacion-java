...
<html lang="es">
    ...
    <body class="d-flex flex-column h-100">
        ...
        <main class="flex-shrink-0">
            <div class="container">
                <h1 class="mt-5">Listado Laboratorios</h1><hr>
                <a href="Routes?accion=agregarLabs" class="btn btn-success">Agregar Nuevo</a>
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <%
                                    ...
                                    List<Laboratorio> list = dao.listarLab();
                                    Iterator<Laboratorio> iter = list.iterator();
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="Routes?accion=editLabs&id=<%= lab.getId()%>" class="btn btn-sm btn-success">Editar</a>
                                        <a href="LabController?accion=eliminarLab&id=<%= lab.getId()%>" class="btn btn-sm btn-danger">Eliminar</a>
                                    </td>
                                </tr>
                                <%
                                    }
