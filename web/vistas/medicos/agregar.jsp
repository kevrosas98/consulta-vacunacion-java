...
<html lang="es">
    ...
    <body class="d-flex flex-column h-100">
        ...
        <main class="flex-shrink-0">
            <div class="container">
                <h1 class="mt-5">Agregar Medico</h1><hr>
                ...
                <div class="col-12 pt-4">
                    ...
                    <form id="form">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="txtTipoDoc" class="form-control sele" style="width: 100%">
                                ...
                                <option value="<%= atrdoc.getValorAtributo()%>"><%= atrdoc.getNombre()%></option>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="txtTipMedico" class="form-control" style="width: 100%">
                                ...
                                <option value="<%= atrmd.getValorAtributo()%>" ><%= atrmd.getNombre()%></option>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="txtLicencia" class="form-control" value="">
                        </div>

                        <div class="mb-3">
                            <input type="button" name="accion" id="submit" class="btn btn-sm btn-success" value="Agregar">
                            <a type="button" href="Routes?accion=listarMedicos" class="btn btn-sm btn-danger"> Volver </a>
                        </div>
        ...
        <script>
            $(document).ready(function () {
                ...
                $('#submit').click(function (event) {
                    ...
                    $.ajax({
                        url: "MedicoController?accion=Agregar",
                        type: 'POST',
                        data: $("#form").serialize()
                    }).done(function (resp) {

                        Swal.fire("Mensaje de Confirmacion", "Medico Registrado", "success").then(function (result) {
                            if (result.value) {
